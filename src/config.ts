...
function readLayer(
  ...
  const layer: ConfigLayer = {
    ...
    learningBlessMinConfidence: read('learningBlessMinConfidence'),
    learningPromoteAfter: read('learningPromoteAfter'),
    learningPromoteMinConfidence: read('learningPromoteMinConfidence'),
