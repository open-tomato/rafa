 ...
 * of each is its command. Five of the ten registered so far wrap a
 ...
 * `module` join with their first action, as `doctor` and `self-update`
 * join with the tasks that bring them.
 */
